...
class AdjustedCostBasisSell(Base):
    ...
    shares = Column(Numeric(12, 8), nullable=False)
    transaction_amount = Column(Numeric(12, 8), nullable=False)
    profit = Column(Numeric(12, 8), nullable=False)
    proceeds = Column(Numeric(12, 8), nullable=False)
    adjusted_cost = Column(Numeric(12, 8), nullable=False)
